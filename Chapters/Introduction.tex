...
amount to a tactical dead end \citep{Power2018}. A corner-kick possession leads to a goal roughly 1.8\,\% of the
time; an open-play possession does so only 1.1\,\% of the time. Corners are
therefore about 64\,\% more likely than open play, on a per-possession basis,
to produce a goal \citep{Power2018}. The decisiveness of those goals matters
just as much as the rate at which they occur: when a team does score from a
corner, that goal is the difference between winning or drawing and not in
roughly three out of four cases \citep{Casal2015}. The aggregate weight of
corners in the goal distribution has also grown over the past decade. In the
2023/24 Premier League season, corners directly contributed to approximately
16\,\% of all non-penalty goals --- a share that has risen as clubs have begun
to invest more deliberately in set-piece preparation.
...
Casal and colleagues \cite{Casal2015} provide the most frequently cited
...
from them. Stafylidis and colleagues \cite{Stafylidis2022, Stafylidis2023}
...
\cite{Liu2025}, analysing 624 corner-kick goals across the Premier
