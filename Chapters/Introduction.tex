...
the average match is decided by a single goal, so any repeatable, high-frequency
situation that even slightly shifts the probability of scoring carries strategic
value out of all proportion to its apparent simplicity. Corner kicks are one
...
amount to a tactical dead end \citep{Power2018}. The data answer this clearly
in their favour. A corner-kick possession leads to a goal roughly 1.8\,\% of the
